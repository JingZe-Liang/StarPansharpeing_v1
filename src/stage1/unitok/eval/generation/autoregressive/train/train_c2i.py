...
def main(args):
    ...
    if rank == 0:
        experiment_dir = (
            f"{args.results_dir}/{args.exp_name}"  # Create an experiment folder
        )
        os.makedirs(
    ...
    if args.gpt_ckpt:
        ...
        train_steps = (
            ...
            else int(args.gpt_ckpt.split("/")[-1].split(".")[0])
        )
            ...
            if train_steps % args.ckpt_every == 0 and train_steps > 0:
                if rank == 0:
                    ...
                    cloud_checkpoint_path = (
                        f"{cloud_checkpoint_dir}/{train_steps:07d}.pt"
                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gpt-ckpt", type=str, default=None, help="ckpt path for resume training"
    )
    parser.add_argument(
        "--gpt-type",
        type=str,
