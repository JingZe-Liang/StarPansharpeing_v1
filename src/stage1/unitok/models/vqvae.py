    ...
    def __init__(self, args):
        ...
        if args.quant_proj == "linear":
            ...
            self.quant_proj = AttnProjection(
                self.encoder.embed_dim, args.vocab_width, args.num_codebooks
            )
        else:
        ...
        if args.quant_proj == "linear":
            ...
            self.post_quant_proj = AttnProjection(
                args.vocab_width, self.encoder.embed_dim, args.num_codebooks
            )
        else:
            raise NotImplementedError
...
if __name__ == "__main__":
    ...
    torch.save(
        cnn.state_dict(), r"C:\Users\16333\Desktop\PyCharm\vlip\local_output\cnn.pth"
    )
