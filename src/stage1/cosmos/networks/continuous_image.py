...
from ..modules import ContinuousFormulation, DecoderType, EncoderType
...
class ContinuousImageTokenizerDiff(nn.Module):
    def __init__(
        self,
        z_channels: int,
        z_factor: int,
        ...
        **kwargs,
        ...
        super().__init__()
        self.name = kwargs.get("name", "ContinuousImageTokenizerDiff")
        self.latent_channels = latent_channels
