...
class DatasetCallback(Callback):
    ...
    def on_train_batch_start(
        ...
        if trainer.global_step == self.step_threshold:
            ...
            trainer.train_dataloader = trainer.video_data._dataloader(
                train=True, batch_size=self.new_batch_size
            )  #  self.new_batch_size
            print(
                f"Batch size changed to {self.new_batch_size} at step {self.step_threshold}"
            )
