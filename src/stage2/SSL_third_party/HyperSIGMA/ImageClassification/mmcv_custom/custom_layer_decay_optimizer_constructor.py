...
def get_num_layer_for_swin(var_name, num_max_layer, depths):
    ...
    if var_name.startswith("encoder.cb_modules.0.patch_embed"):
        ...
        return 0
    elif var_name.startswith("encoder.layers") or var_name.startswith("encoder.levels"):
...
class CustomLayerDecayOptimizerConstructor_InternImage(DefaultOptimWrapperConstructor):
    def add_params(self, params, module, prefix="", is_dcn_module=None):
        ...
        print("Build CustomLayerDecayOptimizerConstructor %f - %d" % (layer_decay_rate, num_layers))
        ...
        for name, param in module.named_parameters():
            ...
            if layer_id == num_layers - 1 and dino_head and ("sampling_offsets" in name or "reference_points" in name):
