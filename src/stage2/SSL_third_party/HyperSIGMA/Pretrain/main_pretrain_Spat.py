...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument("--model", default="spat_mae_b", type=str, metavar="MODEL", help="Name of model to train")
    ...
    parser.add_argument(
        ...
        default="100bands",
        type=str,
        choices=["100bands", "rand3bands", "rand3bandsL"],
        help="band selection:rand3bandsL,random3bands on larger image size",
    )
    parser.add_argument("--in_channels", default=100, type=int, help="data input channels")
    parser.add_argument("--patch_size", default=8, type=int, help="patch size for patch embedding")
...
def main(args):
    if "SLURM_NTASKS" in os.environ.keys():
        ...
        torch.distributed.init_process_group(
            backend="nccl", init_method=dist_url, world_size=args.world_size, rank=args.rank
        )  # 分布式TCP初始化
