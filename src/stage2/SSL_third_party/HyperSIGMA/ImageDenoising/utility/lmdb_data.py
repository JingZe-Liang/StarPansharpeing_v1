...
def create_lmdb_train(
    datadir, fns, name, matkey, crop_sizes, scales, ksizes, strides, load=h5py.File, augment=True, seed=2017
):
    """
...
def createDCmall():
    ...
    create_lmdb_train(
        datadir,
        fns,
        "/data/HSI_Data/Hyperspectral_Project/WDC/wdc",
        "data",  # your own dataset address
        crop_sizes=None,
        scales=(1, 0.5, 0.25),
        ksizes=(191, 64, 64),
