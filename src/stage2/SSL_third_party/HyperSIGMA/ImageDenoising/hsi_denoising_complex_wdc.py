...
if __name__ == "__main__":
    ...
    train_transform = Compose(
        [
            ...
            SequentialSelect(
                transforms=[lambda x: x, AddNoiseImpulse(), AddNoiseImpulse(), AddNoiseStripe(), AddNoiseDeadline()]
            ),
            HSI2Tensor(),
        ]
    )
    ...
    """Test-Dev"""
    basefolder = (
        "/mnt/code/users/yuchunmiao/hypersigma-master/data/Hyperspectral_Project/WDC/test_noise/complex/patch_mixture/"
    )
    ...
    mat_loaders = [
        DataLoader(mat_dataset, batch_size=1, shuffle=False, num_workers=1, pin_memory=opt.no_cuda)
