...
class SSFusionFramework(torch.nn.Module):
    def __init__(self, img_size=None, in_channels=None, scale=4):
        ...
        self.spat_encoder.init_weights(
            "/mnt/code/users/yuchunmiao/SST-master/pre_train/spat-vit-base-ultra-checkpoint-1599.pth"
        )

        self.spec_encoder.init_weights(
            "/mnt/code/users/yuchunmiao/SST-master/pre_train/spec-vit-base-ultra-checkpoint-1599.pth"
        )
...
def spat_vit_b_rvsa(inchannels=100, original_channels=191, img_size=64, args=None):
    model = SSFusionFramework(img_size=32, in_channels=original_channels, scale=args.n_scale)
    return model
