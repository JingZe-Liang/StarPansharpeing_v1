...
if __name__ == "__main__":
    ...
    set_logger_file("data2/JL-16/JL_16_litdata.log", "debug", add_time=True)
    ...
    webdataset_pts = "data2/JL-16/JL_16_litdata"
    all_msi_files_s = list(Path("data2/JL-16").rglob("*.tif"))
